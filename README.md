...
| What | Where |
|---|---|
| **Live status** | [health.json](https://tashingagwatidzo776-max.github.io/ayla/health.json) — regenerated by every Pages deploy; `"healthy": true` = coverage gate passing and no open drift issues. [Human-readable page](https://tashingagwatidzo776-max.github.io/ayla/health-status.html) |
