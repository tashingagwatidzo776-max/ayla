...
diff --git a/tests/DongGfx.Core.Tests/FxBrainTests.cs b/tests/DongGfx.Core.Tests/FxBrainTests.cs
new file mode 100644
index 0000000..2f35756
--- /dev/null
+++ b/tests/DongGfx.Core.Tests/FxBrainTests.cs
@@ -0,0 +1,312 @@
